:PROPERTIES:
:ID:       1d5f4abb-be4f-41ec-9775-bf059f2c5ed5
:NAMESPACE: Blog Post
:END:
#+title: Using a Makefile With My Website
#+date: [2021-03-12 Fri 17:47]

#+hugo_section: blog
#+hugo_type: post
#+hugo_draft: false
#+hugo_custom_front_matter: :featured false :enableToc false
#+hugo_slug: makefile-website
#+hugo_bundle: using-a-makefile-with-my-website
#+filetags: 
#+hugo_tags: Programming Webdev HTML Makefile Hugo
#+hugo_categories: Programming Webdev Hugo
